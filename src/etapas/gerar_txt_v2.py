...
cols_1100 = ['CHV_DOC', 'DATA', 'NUM_ITEM', 'IND_OPER', 'COD_ITEM', 'CFOP','QTD_CAT', 'ICMS_TOT_PCAT', 'VLR_CONFR_PCAT', 'COD_LEGAL', 'FONTE']
...
arquivo_1050 = ler_arquivo_para_dataframe(bucket_name, f'Cat42/{nome_empresa.title()}/1050/1050_{nome_empresa.title()}_{cnpj}_v2.xlsx', file_type='xlsx')
...
#for date in ['112019']:
    ...
    df_1100_ = df_1100_[['COD_REG','CHV_DOC','DATA','NUM_ITEM','IND_OPER','COD_ITEM','CFOP','QTD_FIN','ICMS_TOT_PCAT','VLR_CONFR_PCAT','COD_LEGAL', 'FONTE']]
    ...
    print(f'Gerado o arquivo 0000 e salvo em Cat42/{nome_empresa.title()}/Txts/Teste_CNPJ_{cnpj}/0000_{date}_{cnpj}_v2.txt')
    ...
    print(f'Gerado o arquivo 0150 e salvo em Cat42/{nome_empresa.title()}/Txts/Teste_CNPJ_{cnpj}/0150_{date}_{cnpj}_v2.txt')
    ...
    print(f'Gerado o arquivo 0200 e salvo em Cat42/{nome_empresa.title()}/Txts/Teste_CNPJ_{cnpj}/0200_{date}_{cnpj}_v2.txt')
    ...
    print(f'Gerado o arquivo 1050 e salvo em Cat42/{nome_empresa.title()}/Txts/Teste_CNPJ_{cnpj}/1050_{date}_{cnpj}_v2.txt')
    ...
    print(f'Gerado o arquivo 1100 e salvo em Cat42/{nome_empresa.title()}/Txts/Teste_CNPJ_{cnpj}/1100_{date}_{cnpj}_v2txt')
