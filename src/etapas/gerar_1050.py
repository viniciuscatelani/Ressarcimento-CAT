...
df_2 = ler_arquivo_para_dataframe(bucket_name=bucket_name, s3_key=f'Cat42/{nome_empresa.title()}/Ficha 3/ficha_3_{nome_empresa.title()}_{cnpj}.xlsx',
                                  file_type='xlsx')
...
salvar_dataframe_no_s3(df_1050, bucket_name,
                       s3_key=f'Cat42/{nome_empresa.title()}/1050/1050_{nome_empresa.title()}_{cnpj}.xlsx',
                       file_type='xlsx')